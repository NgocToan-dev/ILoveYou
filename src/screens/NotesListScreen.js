  ...
  return (
    <LoveBackground>
      <View style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.headerInfo}>
            ...
            <Text style={styles.headerSubtitle}>
              {type === NOTE_TYPES.SHARED ? 'Ghi chú chia sẻ' : 'Ghi chú riêng tư'}
            </Text>
          </View>
        ...
        >
          {/* Category Header */}
          <View style={[styles.categoryHeader, { backgroundColor: categoryInfo.color + '20' }]}>
            ...
            {notes.length > 0 ? (
              ...
              <View style={styles.emptyContainer}>
                ...
                >
                  ...
                  <Text style={styles.createFirstButtonText}>Tạo ghi chú đầu tiên</Text>
                </TouchableOpacity>
              </View>
            )}
          </View>
