        ...
        >
          ...
          <View style={styles.section}>
            ...
            <View style={styles.settingItem}>
              ...
              <Switch
                value={notifications}
                onValueChange={setNotifications}                trackColor={{ false: '#F8BBD9', true: '#E91E63' }}
            ...
            <View style={styles.settingItem}>
              ...
              <Switch
                ...
                disabled={true}                trackColor={{ false: '#F8BBD9', true: '#E91E63' }}
            ...
            <View style={styles.settingItem}>
              ...
              <Switch
                ...
                onValueChange={setPrivateProfile}                trackColor={{ false: '#F8BBD9', true: '#E91E63' }}
